...
// PI - SBOX in dec or SBOX - PI in hex
#[allow(dead_code)]
pub const PI: [u8; 256] = [
...
// SHUFFLED_LIN_TABLE is the result of combining constants from LPS transforms
// Increase performance significantly
// For SHUFFLED_LIN_TABLE[i][j]
//      i - 8 columns of i row for A
//      j - SBOX number
